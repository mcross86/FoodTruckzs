...
export default function VendorOperationalSetupPage() {
  ...
  return (
    <main style={{ fontFamily: "Arial, sans-serif", margin: "32px auto", maxWidth: 1180 }}>
      <h1>Vendor Operational Setup</h1>
      <p>
        Minimal development screen for vendor profile, service area, availability, menu, and billing
        setup APIs. Sign in once, then choose the active vendor instead of pasting tokens.
      </p>
      ...
      <section style={{ display: "flex", flexWrap: "wrap", gap: 8, marginTop: 24 }}>
        <button onClick={() => void runRequest({ path: "/api/v1/marketplace/cuisines" })}>
          Load Cuisines
        </button>
        <button
          onClick={() => {
